...
export default function Header() {
  ...
  return (
    <>
      <header className={`border-b ${scrollDirection === "down" ? "sticky" : ""} z-50`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <Button variant="ghost" size="icon" onClick={() => setCartOpen(!cartOpen)} className="hidden md:flex">
      ...
      {/* Cart Overlay - Render HeaderCart only on larger screens */}
      <HeaderCart cartOpen={cartOpen} setCartOpen={setCartOpen} className="hidden md:block" />
