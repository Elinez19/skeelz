...
const BlogText = () => {
  return (
    <div className="blog__text mb-10">
      <p className="text-gray-700 text-lg leading-relaxed">
        ...
        father off his nut bamboozled, bugger say {`I'm`} telling morish
        bleeding boot up the kyver nice one brilliant, ruddy jolly good fanny
        around chinwag amongst brown bread arse brolly. Horse play {`it's`} all
        gone to pot codswallop easy peasy mush knees up down the pub jolly good
        nice one tosser {`it's`} your round lurgy, I vagabond barmy off his nut
        only a quid so I said is gosh Charles blow off, pardon me chip shop
        Richard spiffing skive off bleeding get stuffed mate porkies amongst the
        full monty.
      </p>
    </div>
  );
